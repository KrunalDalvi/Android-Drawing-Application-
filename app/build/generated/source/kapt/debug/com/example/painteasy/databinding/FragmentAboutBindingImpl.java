...
public class FragmentAboutBindingImpl extends FragmentAboutBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.cvAppInfo, 1);
        sViewsWithIds.put(R.id.ivAppIcon, 2);
        sViewsWithIds.put(R.id.tvAppName, 3);
        sViewsWithIds.put(R.id.cvAppChangeLog, 4);
        sViewsWithIds.put(R.id.tvChangelog, 5);
    }
    // views
    @NonNull
