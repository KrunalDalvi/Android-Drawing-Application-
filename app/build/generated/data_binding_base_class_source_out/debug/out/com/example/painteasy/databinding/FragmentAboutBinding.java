...
public abstract class FragmentAboutBinding extends ViewDataBinding {
  @NonNull
  public final CardView cvAppChangeLog;
  ...
  protected FragmentAboutBinding(Object _bindingComponent, View _root, int _localFieldCount,
      CardView cvAppChangeLog, CardView cvAppInfo, ImageView ivAppIcon, TextView tvAppName,
      TextView tvChangelog) {
    super(_bindingComponent, _root, _localFieldCount);
    this.cvAppChangeLog = cvAppChangeLog;
    this.cvAppInfo = cvAppInfo;
